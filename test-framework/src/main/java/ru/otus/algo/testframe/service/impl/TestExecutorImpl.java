...
import ru.otus.algo.testframe.service.TestDataWriter;
...
public class TestExecutorImpl implements TestExecutor {
    ...
    private final TestDataWriter testDataWriter = new TestDataWriter();

    @Override
    public void execute(String path, TestExecutable testExecutable) throws IOException {
        final Map<Integer, TestData> testDataMap = testDataWriter.writeAllTestData(path);
        testDataMap
                .keySet()
